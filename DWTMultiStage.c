...
int main(void){
	...
	for(i = 0; i < ITERATIONS; i++)
	{
		...
		DWT(resultLLL, e, resultLLLH, resultLLLL);
		DWT(resultLLH, e, resultLLHH, resultLLHL);
		DWT(resultLLLH, f, resultLLLHH, resultLLLHL);
	}
	...
	for(i = 0; i < ITERATIONS; i++)
	{
		IDWT(resultLLLHH, g, resultLLLHL, g, signalLLLHH, signalLLLHL, reconSignalLLLH, f);
		IDWT(reconSignalLLLH, f, resultLLLL, f, signalLLLH, signalLLLL, reconSignalLLL, e);
		IDWT(resultLLHH, f, resultLLHL, f, signalLLHH, signalLLHL, reconSignalLLH, e);
		IDWT(reconSignalLLH, e, reconSignalLLL, e, signalLLH, signalLLL, reconSignalLL, d);
		IDWT(resultLH, d, reconSignalLL, d, signalLH, signalLL, reconSignalL, u);
